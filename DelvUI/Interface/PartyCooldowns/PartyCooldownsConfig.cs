...
namespace DelvUI.Interface.PartyCooldowns
{
    ...
    public class PartyCooldownsDataConfig : PluginConfigObject
    {
        ...
        public bool Draw(ref bool changed)
        {
            ...
            if (ImGui.BeginTable("##AetherUI_PartyCooldownsTable", 8, flags, new Vector2(900, 500)))
            {
            ...
            if (_needsPopupOpen)
            {
                ImGui.OpenPopup("Exclude Jobs##AetherUI");
        ...
        private void DrawJobsListForCooldown(PartyCooldownData cooldown)
        {
            ...
            if (ImGui.BeginPopup("Exclude Jobs##AetherUI", ImGuiWindowFlags.NoMove))
            {
                ImGui.Text(title);
